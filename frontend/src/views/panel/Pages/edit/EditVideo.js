                ...
                <div className="p-6 space-y-6">
                  <div className="grid grid-cols-6 gap-6 ">
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <div className="w-full max-h-fit shadow-sm bg-gray-50 border p-2 rounded-md border-gray-300 text-gray-900 sm:text-sm  focus:ring-pink-600 focus:border-pink-600   dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-pink-500 dark:focus:border-pink-500">
                        <ReactPlayer
                          width="100%"
                          height="100%"
                          url={video.video_url}
